...
\begin{figure}[htb!]
	\centering
	\caption{Possíveis posições para as juntas $\theta_{1}$, $\theta_{5}$ e $\theta_{3}$ do UR5}
	\label{fig:solucoes-inversa}
	\subfloat[Ombro na posição esquerda]{%
		\includegraphics[width=0.3\textwidth]{images/shoulder_left.jpg}%
		\label{fig:shoulder-left}%
	}%
	\hspace{1cm}%
	\subfloat[Ombro na posição direita]{%
		\includegraphics[width=0.3\textwidth]{images/shoulder_right.jpg}%
		\label{fig:shoulder-right}%
	}%
	\vfill%
	\subfloat[Pulso na posição superior]{%
		\includegraphics[width=0.3\textwidth]{images/wrist_up.jpg}%
		\label{fig:wrist-up}%
	}%
	\hspace{1cm}%
	\subfloat[Pulso na posição inferior]{%
		\includegraphics[width=0.3\textwidth]{images/wrist_down.jpg}%
		\label{fig:wrist-down}%
	}%
	\vfill%
	\subfloat[Cotovelo na posição superior]{%
		\includegraphics[width=0.3\textwidth]{images/elbow_up.jpg}%
		\label{fig:elbow-up}%
	}%
	\hspace{1cm}%
	\subfloat[Cotovelo na posição inferior]{%
		\includegraphics[width=0.3\textwidth]{images/elbow_down.jpg}%
...
\begin{figure}[htp!]
	\centering
	\caption{Posicionamentos da garra integrada ao UR5 utilizados para validação dos cálculos
	de cinemática direta e inversa
	}
	\label{fig:posicionamentos-da-garra}
	\subfloat[\textit{Grasp} pelo lado esquerdo]{%
		\includegraphics[width=0.48\textwidth]{images/grasp_lateral_esquerda.jpg}%
		\label{fig:frames-notacao-dh}%
	}%
	\hfill%
	\subfloat[\textit{Grasp} pelo lado direito]{%
		\includegraphics[width=0.48\textwidth]{images/grasp_lateral_direita.jpg}%
		\label{fig:frames-notacao-urdf}%
	}%
	\vfill%
	\subfloat[\textit{Grasp} pela frente]{%
	\includegraphics[width=0.48\textwidth]{images/grasp_frente.jpg}%
	\label{fig:frames-notacao-dh}%
	}%
	\hfill%
	\subfloat[\textit{Grasp} pela parte superior]{%
		\includegraphics[width=0.48\textwidth]{images/grasp_superior.jpg}%
		\label{fig:frames-notacao-urdf}%
	}%
\end{figure}
...
Para tornar este cálculo automático, foi criado uma rotina de programação usando a linguagem Python, e APIs 
